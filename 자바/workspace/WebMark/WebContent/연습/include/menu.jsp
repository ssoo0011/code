...
<nav class="navbar navbar-expand  navbar-dark bg-dark">
	<div class="container">
		...
		<%
			...
			if(!loginId.equals("")){
				cookieCheck = "checked";
				ssId =(String)session.getAttribute("loginId");
				
		%>	
						
		<div class="navbar-header">
			
			<form  action="../Process/LogOutProcess.jsp?id=<%=loginId%>" method="post">
				<span style = 'color : gray'><%=loginId%>님 환영합니다! </span>
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="../UI/logIn.jsp?id=<%=ssId%>">login</a>
			</form>	
		</div>
		<%} %>
	</div>
